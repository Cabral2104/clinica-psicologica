...
import Pacientes from './pages/patients/Pacientes'; // <-- Importamos la nueva vista
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<MainLayout />}>
              ...
              {/* <-- Reemplazamos el div estático por el componente real --> */}
              <Route path="/pacientes" element={<Pacientes />} />
              
              <Route path="/agenda" element={<div className="p-8 font-bold">Agenda...</div>} />
